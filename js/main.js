...
const TRANSLATIONS = {
  es: {
    ...
    dia_btn_wa: 'WhatsApp',
    dia_btn_photos: 'Enviar fotos del daño',
    dia_btn_insurers: 'Ver aseguradoras',
    dia_btn_fire: 'Daños por fuego / humo',
    dia_btn_water: 'Daños por agua / inundación',
  ...
  en: {
    ...
    dia_btn_wa: 'WhatsApp',
    dia_btn_photos: 'Send photos of the damage',
    dia_btn_insurers: 'View insurers',
    dia_btn_fire: 'Fire / smoke damage',
    dia_btn_water: 'Water / flood damage',
